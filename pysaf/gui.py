...
"""Main tkinter GUI file used by all operating systems other than Windows."""
...
class GuiTk():
    ...
    def create_license_button(self, gs):
        ...
        if self.license_button_var.get() == 1:
            ...
            self.license_file_label.grid_configure(pady=5)
            ...
            self.license_bundle_label.grid_configure(pady=5)
